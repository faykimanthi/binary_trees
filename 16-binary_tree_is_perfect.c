 ...
 * @tree: Represents a pointer to the root node of the tree to check.
 ...
 * @tree: Represents a pointer to the node to measure the depth of.
 ...
 * @tree: Represents a pointer to the root node of the tree to check.
 * @leaf_depth: Represents the depth of one leaf in the binary tree.
 * @level: Represents the level of current node.
 *
